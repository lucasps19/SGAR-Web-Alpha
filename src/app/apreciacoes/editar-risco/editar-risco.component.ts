...
@Component({
  selector: 'app-editar-risco',
  templateUrl: './editar-risco.component.html',
  styleUrls: ['./editar-risco.component.css']
})
export class EditarRiscoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.idRisco = (this._route.snapshot.paramMap.get('idRisco'));
  ...
  public buscarRisco(){
    this.apreciacaoService.buscarRisco(parseInt(this.idRisco)).then(dados => {
      this.novoRisco.id = dados.id;
      this.novoRisco.cicloVida.id = dados.idCicloVida;
      this.novoRisco.tarefa.id = dados.idTarefa;
      this.novoRisco.atividade = dados.atividade;
      this.novoRisco.tipoGrupoPerigo.id = dados.idTipoGrupoPerigo;
      this.novoRisco.dano.id = dados.idDano;
      this.novoRisco.onde = dados.onde;
      this.novoRisco.riscoABNT12100.id = dados.idRiscoABNT12100;
